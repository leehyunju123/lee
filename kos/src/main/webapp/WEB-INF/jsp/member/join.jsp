...
<main>
	<div class="section">
		...
		<div class="input-container">
			<input type="text" id="input-display1" class="input-display"
				placeholder="(4자리 숫자를 입력해주세요)" maxlength="4">
	...
	<div class="button-container">
		...
		<button class="button confirm-button" onclick="showAlert();">가입하기</button>
...
<script>
    function showAlert() {
        if (confirm('가입이 완료되었습니다. 확인을 누르면 다음 페이지로 이동합니다.')) {
            window.location.href = 'http://localhost:9090/order/payment';
        }
    }
</script>
